...
export function generateListOfDaysForMonthAndYear(month, year, { locale = undefined } = {}) {
    ...
    const startIndex = weekdayList.findIndex((d) => d === formatToWeekday(dates[0], locale, {}));
